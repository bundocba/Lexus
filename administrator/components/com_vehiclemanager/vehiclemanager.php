...
function editCategory($section = '', $uid = 0)
{
    ...
    $alone_category = getLayoutsVeh('com_vehiclemanager','alone_category');
    $alone_category2 = Array();
    $alone_category2[] = JHtml::_('select.option', '', 'Use Global');
    foreach($alone_category as $value){
        $alone_category2[] = JHtml::_('select.option', "$value", "$value"); 
    }
    $lists['alone_category'] = mosHTML::selectList($alone_category2, 'alone_category2', 'size="1" ', 'value', 'text', $params2->alone_category);
    
    $view_vehicle_layout = getLayoutsVeh('com_vehiclemanager','view_vehicle');
    $view_vehicle = Array();
    $view_vehicle[] = JHtml::_('select.option', '', 'Use Global');
    foreach($view_vehicle_layout as $value){
        $view_vehicle[] = JHtml::_('select.option', "$value", "$value"); 
    }
    $lists['view_vehicle'] = mosHTML::selectList($view_vehicle, 'view_vehicle', 'size="1" ', 'value', 'text', $params2->view_vehicle);
...
//***************************************************
    $all_categories_layout = getLayoutsVeh('com_vehiclemanager','all_categories');
    $all_categories = Array();
    $all_categories[] = JHtml::_('select.option', '', 'Use Global');
    foreach($all_categories_layout as $value){
        $all_categories[] = JHtml::_('select.option', "$value", "$value"); 
    }
    ...
    $view_type = getLayoutsVeh('com_vehiclemanager','alone_category');
    $view_type2 = Array();
    $view_type2[] = JHtml::_('select.option', '', 'Use Global');
    foreach($view_type as $value){
        $view_type2[] = JHtml::_('select.option', "$value", "$value"); 
    }
    $lists['view_type'] = mosHTML::selectList($view_type2, 'view_type2', 'size="1" ', 'value', 'text', $vehiclemanager_configuration['view_type']);
    ...
    $show_search_vehicle_layout = getLayoutsVeh('com_vehiclemanager','show_search_vehicle');
    $show_search_vehicle = Array();
    $show_search_vehicle[] = JHtml::_('select.option', '', 'Use Global');
    foreach($show_search_vehicle_layout as $value){
        $show_search_vehicle[] = JHtml::_('select.option', "$value", "$value"); 
    }
