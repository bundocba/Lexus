...
class mosVehicleManager extends JTable
{
    ...
    function getReviews()
    {
        $this->_db->setQuery("SELECT id FROM #__vehiclemanager_review WHERE fk_vehicleid='$this->id' and published=1 ORDER BY id");
        if (version_compare(JVERSION, '3.0', 'lt'))
        {
    ...
    {
        $this->_db->setQuery("SELECT id FROM #__vehiclemanager_rent WHERE fk_vehicleid='$this->id' "
    ...
    {
        $this->_db->setQuery("SELECT id FROM #__vehiclemanager_rent_request WHERE fk_vehicleid='$this->id'"
         . $exclusion . " ORDER BY id");
        if (version_compare(JVERSION, '3.0', 'lt'))
        {
            $tmp = $this->_db->loadResultArray();
    ...
    {
        $this->_db->setQuery("SELECT id FROM #__vehiclemanager_buying_request WHERE fk_vehicleid='$this->id'"
         . $exclusion . " ORDER BY id");
        if (version_compare(JVERSION, '3.0', 'lt'))
        {
            $tmp = $this->_db->loadResultArray();
