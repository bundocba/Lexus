    ...
    var func = {
                        ...
                        '<div class="tcvnSlideSet-inputs">' +
                            '<div class="tcvnSlideSet-maininfo">' +
								...
								'<div class="tcvnSlideSet-input">' +
                                    ...
                                    '<input class="tcvnSlideSet-link"/>' +
                                '</div>' +
                                '<div class="clr"></div>' +
								'<div class="tcvnSlideSet-input">' +
                                    '<label>Link Target (Option - Eg: _blank | _self | _parent | _top)</label>' +
                                    '<input class="tcvnSlideSet-target" value="_blank" />' +
                                '</div>' +
                                '<div class="clr"></div>' +
                                '<div class="tcvnSlideSet-input">' +
                                    '<label>Image Caption</label>' +
                                    '<textarea class="tcvnSlideSet-text" style="width:99%; height:100px">' +
                                        '<h3>Image Caption Title Here!</h3>\n' +
										'<p>This is description of image. You can insert HTML code there!</p>' + 
									'</textarea>' +
                                '</div>' +
                                '<div class="clr"></div>' +
                            '</div>' +
        ...
        generateSlideSetValue: function(){
            ...
            $.each($('#tcvnSlideSet-container .tcvnSlideSet-item'), function(i, item){
				...
				data['list'][i].link = $(item).find('input.tcvnSlideSet-link').val();
				data['list'][i].target = $(item).find('input.tcvnSlideSet-target').val();
