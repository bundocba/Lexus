...
class JFormFieldData extends JFormField
{
    ...
    protected function getInput()
    {
		...
		{
            $j30 = 0;
            $doc->addScript(JURI::root().'modules/mod_vina_nivo_image_slider/assets/js/jquery-1.8.3.min.js', 'text/javascript');
            $doc->addScript(JURI::root().'modules/mod_vina_nivo_image_slider/assets/js/chosen.jquery.min.js', 'text/javascript');
            $doc->addStyleSheet(JURI::root().'modules/mod_vina_nivo_image_slider/assets/css/chosen.css', 'text/css');
        }

        $doc->addScript('https://ajax.googleapis.com/ajax/libs/jqueryui/1.9.1/jquery-ui.min.js', 'text/javascript');
        $doc->addScript(JURI::root().'modules/mod_vina_nivo_image_slider/libs/elements/media/slideset.js', 'text/javascript');
        $doc->addScript(JURI::root().'modules/mod_vina_nivo_image_slider/libs/elements/media/json2.js', 'text/javascript');

        $doc->addStyleSheet('https://ajax.googleapis.com/ajax/libs/jqueryui/1.9.0/themes/cupertino/jquery-ui.css', 'text/css');
        $doc->addStyleSheet(JURI::root().'modules/mod_vina_nivo_image_slider/libs/elements/media/slideset.css', 'text/css');

        if($this->value){
            $slide = json_decode($this->value);
        }else{
            $slide = json_decode('{"src":"list","list":[{"name":"Slide item 1","img":"modules/mod_vina_nivo_image_slider/samples/image-1.jpg","text":"<h3>Vina Nivo Image Slider</h3>\n<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh.</p>\n<div class=\"link-wrapper\">\n      <a class=\"btn-style01\" href=\"#\">Download now >></a>\n      <a class=\"btn-style02\" href=\"#\">View all modules >></a>\n</div>"},{"name":"Slide item 2","img":"modules/mod_vina_nivo_image_slider/samples/image-2.jpg","text":"<h3>Image Caption Title Here!</h3>\n<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh.</p>\n"},{"name":"Slide item 3","img":"modules/mod_vina_nivo_image_slider/samples/image-3.jpg","text":"<h3>Image Caption Title Here!</h3>\n<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh.</p>\n"},{"name":"Slide item 4","img":"modules/mod_vina_nivo_image_slider/samples/image-4.jpg","text":"<h3>Image Caption Title Here!</h3>\n"},{"name":"Slide item 5","img":"modules/mod_vina_nivo_image_slider/samples/image-5.jpg","text":"<h3>Image Caption Title Here!</h3>\n<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh.</p>\n"}],"dir":{"path":"modules/mod_vina_nivo_image_slider/samples/","ext":".jpg,.png"},"art":{}}');
        }
        ob_start();
        ?>
    <style type="text/css">
        ...
        <div id="tcvnSlideSet-dir">
            <div class="tcvnSlideSet-item">
                <div class="tcvnSlideSet-input">
                    <label>Path</label>
                    <input id="tcvnSlideSet-path" value="<?php if(isset($slide->dir->path)) echo $slide->dir->path; else echo 'modules/mod_vina_nivo_image_slider/samples/'?>"/>
                </div>
                            ...
                            <div style="display: none;">
                                <div class="tcvnSlideSet-inputs">
                                    <div class="tcvnSlideSet-maininfo">
                                        ...
                                        <div class="clr"></div>
										<div class="tcvnSlideSet-input">
                                            <label>Image Link (Option - Eg: http://vinagecko.com)</label>
                                            <input class="tcvnSlideSet-link" value="<?php echo @$set->link;?>"/>
                                        </div>
                                        <div class="clr"></div>
										<div class="tcvnSlideSet-input">
                                            <label>Link Target (Option - Eg: _blank | _self | _parent | _top)</label>
                                            <input class="tcvnSlideSet-target" value="<?php echo @$set->target;?>"/>
                                        </div>
                                        <div class="clr"></div>
                                        <div class="tcvnSlideSet-input">
