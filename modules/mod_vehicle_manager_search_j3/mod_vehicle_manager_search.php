...
$yearlist = mosHTML :: selectList($year, 'yearfrom', 'class="inputbox" size="1" style="width:70px"', 'value', 'text');
$yearlistto = mosHTML :: selectList($year_to, 'yearto', 'class="inputbox" size="1" style="width:70px"', 'value', 'text');
...
$pricelist = mosHTML :: selectList($price, 'pricefrom', 'class="inputbox" size="1" style="width:68px"', 'value', 'text');
$pricelistto = mosHTML :: selectList($price_to, 'priceto', 'class="inputbox" size="1" style="width:70px"', 'value', 'text');
?>
...
if (version_compare(JVERSION, "3.0.0", "lt"))
    require(JModuleHelper::getLayoutPath('mod_vehicle_manager_search', $params->get('layout', 'default'))); else
    require (JModuleHelper::getLayoutPath('mod_vehicle_manager_search_j3', $params->get('layout', 'default')));	
    ?>		
    </form>
</div>
